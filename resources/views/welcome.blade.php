  ...
  <div
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
      ...
      <div class="text-center">
        <h2 class="mt-4 fs-1 font-semibold text-gray-900 dark:text-white">COVID Vaccine Registration System</h2>
      </div>
          ...
          <div
            ...
            <div>
              <div class="d-flex items-center">
                ...
                <h2 class="ml-4 text-xl font-semibold text-gray-900 dark:text-white">Search & See Your Vaccine
                  Regestration Status!</h2>
              </div>
              <form method="POST" action="{{ route('search') }}" class="mt-6">
                @csrf
                <div class="form-group">
                  <input class="form-control form-control-lg @error('nid') is-invalid @enderror" name="nid"
                    type="text" placeholder="NID Number" value="{{ old('nid') }}">
                  @error('nid')
            ...
            <div
              ...
              <div>
                <div class="d-flex items-center">
                  ...
                  <h2 class="ml-4 text-xl font-semibold text-gray-900 dark:text-white">Search Result</h2>
                </div>
                @if (session('user'))
                  @php
                    $user = session('user');
                  ...
                  <h4 class="text-xl mt-3">User Information:</h4>
                  <p class="fs-4"><strong>Name:</strong> {{ $user->name }}</p>
                ...
                @else
                  <h4 class="fs-5 mt-3"><strong>Registration Status:</strong>
                    <span class="badge text-bg-secondary">Not registered</span>
                    <a href="{{ route('register') }}" class="ml-2 text-primary">Register Here</a>
                  </h4>
                @endif
